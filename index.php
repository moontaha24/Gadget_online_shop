...
<body>
    ...
    <section class="top-selling">
        ...
        <div class="top-selling-product-row shop-product-row gap">
            ...
            <?php while ($result = mysqli_fetch_assoc($selling)) { ?>
    ...
    <section class="top-selling">
        ...
        <div class="home-cat-row gap">

            <div class="home-cat-l">
                <a href="phone.php"><img src="img/cat1.png" alt=""></a>
            </div>

            <div class="home-cat-m">
                <a href="headphone.php"><img src="img/cat2.png" alt=""></a>
                <a href="Lptp.php"><img src="img/cat3.png" alt=""></a>
            </div>

            <div class="home-cat-r">
                <a href="watch.php"><img src="img/cat4.png" alt=""></a>
            </div>
    ...
    <section class="shop-by-brands">
        ...
        <div class="shop-brand-row gap">


            <div class="shop-brand-img">
                <img src="img/applelogo.png" alt="">
            </div>

            <div class="shop-brand-img">
                <img src="img/samsunglogo.png" alt="">
            </div>
            ...
            <div class="shop-brand-img">
                <img src="img/vivologo.png" alt="">
            </div>

            <div class="shop-brand-img">
                <img src="img/asuslogo.png" alt="">
            </div>

            <div class="shop-brand-img">
                <img src="img/delllogo.png" alt="">
            </div>
