...
<body>
    ...
    <section>
        <div class="shop-category-menu gap">
            <ul>
                ...
                <li class="shop-active"><a href="phone.php">Phones</a></li>
                <li><a href="tab.php">Tab</a></li>
                <li><a href="Lptp.php">Laptop</a></li>
                <li><a href="watch.php">Watch</a></li>
                <li class="shop-active"><a href="headphone.php">Accessories</a></li>
            </ul>
        </div>
    </section>
    ...
    <section class="top-selling">
        ...
        <div class="top-selling-product-row shop-product-row gap">
            ...
            <?php while ($result = mysqli_fetch_assoc($headphone)) { ?>
